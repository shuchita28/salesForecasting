...
scale_fill_identity(name = '', guide = 'legend',labels = c('m1')) +
scale_colour_manual(name = 'Model',   values=c('darkred'='darkred','red'='red','blue'='blue','sienna4'='sienna4'), labels = c('Weekly Sales','ARIMA Prediction','NNETAR Prediction','XGboost prediction')) +
scale_linetype_manual(name = 'Model', values=c('solid'='solid','dashed'='dashed','dotted'='dotted','longdash'='longdash'), labels = c('Weekly Sales','ARIMA Prediction','NNETAR Prediction','XGboost prediction'))
```
